...
export function ProductCard({ product, onAddToCart, productId }: ProductCardProps) {
  ...
  return (
    <>
      ...
      <div 
        className="group bg-white overflow-hidden shadow-2xl hover:shadow-4xl transition-all duration-300 hover:-translate-y-2"
        ...
        <div className="p-5">
          ...
          <div className="relative">
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-gray-900 to-black text-white font-bold text-base rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-300 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            >
              <span className={`transition-all duration-300 flex items-center justify-center gap-2 ${
                ...
                <span>{isAdding ? 'Adding...' : inCart ? 'In Cart ✓' : 'Add to Cart'}</span>
                {product.type === 'Resale' && (
